...
> Evidence snapshot: 2026-07-13 · WebObsidian implementation `3d27b5a` · plugin source/tag `a533066`/`0.1.8` ·
...
| Native plugin release | [`central-vault-sync` 0.1.8](https://github.com/picassio/central-vault-sync/releases/tag/0.1.8), source/tag `a533066`; release CI [29247571867](https://github.com/picassio/central-vault-sync/actions/runs/29247571867), plus Node 20/22/24 CI [29247570394](https://github.com/picassio/central-vault-sync/actions/runs/29247570394). |
| Real Obsidian Linux | [`evidence/obsidian-linux-1.12.7-plugin-0.1.8-release.png`](evidence/obsidian-linux-1.12.7-plugin-0.1.8-release.png) and its [evidence notes](evidence/README.md): exact public 0.1.8 bytes retain prior lifecycle/editor/performance evidence and derive the unresolved-conflict badge from the authoritative server after restart, sync, and resolution. |
...
| 36 — native plugin | **PARTIAL** | M36.1–M36.9 implementation/release work and the full real-Linux lifecycle/file-operation/editor-safety matrix are complete; public 0.1.8 exists. | M36.2 npm core publication, M36.7 mobile physical lifecycle, M36.8 Windows/macOS/mobile matrix, and M36.10 Community review remain open. |
