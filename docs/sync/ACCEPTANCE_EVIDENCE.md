...
> Evidence snapshot: 2026-07-13 · WebObsidian implementation `3d27b5a` · plugin source/tag `2ba5b03`/`0.1.6` ·
...
| Native plugin release | [`central-vault-sync` 0.1.6](https://github.com/picassio/central-vault-sync/releases/tag/0.1.6), source/tag `2ba5b03`; release CI [29246318823](https://github.com/picassio/central-vault-sync/actions/runs/29246318823), plus Node 20/22/24 CI [29246317400](https://github.com/picassio/central-vault-sync/actions/runs/29246317400). |
| Real Obsidian Linux | [`evidence/obsidian-linux-1.12.7-plugin-0.1.6-release.png`](evidence/obsidian-linux-1.12.7-plugin-0.1.6-release.png) and its [evidence notes](evidence/README.md): exact public 0.1.6 bytes retain the prior lifecycle matrix and prove an unsaved open editor cannot be replaced by a racing remote revision; the local text becomes an exact durable conflict copy. Pause also defers remote application until explicit resume. |
...
| 36 — native plugin | **PARTIAL** | M36.1–M36.9 implementation/release work and the full real-Linux lifecycle/file-operation/editor-safety matrix are complete; public 0.1.6 exists. | M36.2 npm core publication, M36.7 mobile physical lifecycle, M36.8 Windows/macOS/mobile matrix, and M36.10 Community review remain open. |
