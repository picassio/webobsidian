...
> Evidence snapshot: 2026-07-14 · WebObsidian implementation `7ab4e4a` · plugin source/tag `db635ed`/`0.1.12` ·
...
| Native plugin release | [`central-vault-sync` 0.1.12](https://github.com/picassio/central-vault-sync/releases/tag/0.1.12), source/tag `db635ed`; release CI [29265127275](https://github.com/picassio/central-vault-sync/actions/runs/29265127275), plus Node 20/22/24 CI [29265124982](https://github.com/picassio/central-vault-sync/actions/runs/29265124982). Exact release-asset SHA-256 digests are recorded below; it consumes public `@picassio/sync-core@0.1.3`. |
