...
> Evidence snapshot: 2026-07-13 · WebObsidian implementation `e83c4cb` · plugin source/tag `db635ed`/`0.1.12` ·
...
| Evidence | Result |
|---|---|
| WebObsidian CI | [Run 29264703837](https://github.com/picassio/webobsidian/actions/runs/29264703837) on commit `e83c4cb`: 129 tests; typecheck/build; OpenAPI and Markdown links; dependency audit; production two-browser and two-headless-client E2E; systemd verification; attested amd64/arm64 source builds for server/headless; non-root smoke. |
