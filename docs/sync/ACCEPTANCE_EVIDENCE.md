...
> Evidence snapshot: 2026-07-13 · WebObsidian implementation `3d27b5a` · plugin source/tag `6f34852`/`0.1.7` ·
...
| Native plugin release | [`central-vault-sync` 0.1.7](https://github.com/picassio/central-vault-sync/releases/tag/0.1.7), source/tag `6f34852`; release CI [29246980083](https://github.com/picassio/central-vault-sync/actions/runs/29246980083), plus Node 20/22/24 CI [29246978388](https://github.com/picassio/central-vault-sync/actions/runs/29246978388). |
| Real Obsidian Linux | [`evidence/obsidian-linux-1.12.7-plugin-0.1.7-release.png`](evidence/obsidian-linux-1.12.7-plugin-0.1.7-release.png) and its [evidence notes](evidence/README.md): exact public 0.1.7 bytes retain the 0.1.6 unsaved-editor/pause safety and prove unchanged reconnect reconciliation performs zero plugin-data writes. Projection path/ID lookups are indexed and the scan yields every 100 paths. |
...
| 36 — native plugin | **PARTIAL** | M36.1–M36.9 implementation/release work and the full real-Linux lifecycle/file-operation/editor-safety matrix are complete; public 0.1.7 exists. | M36.2 npm core publication, M36.7 mobile physical lifecycle, M36.8 Windows/macOS/mobile matrix, and M36.10 Community review remain open. |
