...
> Evidence snapshot: 2026-07-14 · WebObsidian implementation `3b2c81b` · plugin source/tag `121e03b`/`0.1.15` ·
...
|---|:---:|---|
| Settings/runtime/API/UI implementation | **PASS** | PRD 1.10, `docs/MULTI_VAULT.md`, settings v4 in-place migration, detached identity-preserving registry, AsyncLocalStorage request context, per-vault runtime/index/watcher/Git/share/workspace state, token/API-key scoping, selector and deep links. |
