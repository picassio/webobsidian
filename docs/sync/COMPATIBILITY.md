...
| `@picassio/sync-core` | 0.1.2 | 1.0 | Platform-neutral ESM | Public npm package; clean registry-origin ESM import and zero-vulnerability dependency install verified. |
